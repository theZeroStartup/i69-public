...
@AndroidEntryPoint
class FragmentUserGifts : BaseUserGiftsFragment() {
    ...
    override fun setupClickListeners() {
        binding.purchaseButton.setOnClickListener {
            ...
            fragSendGifts?.giftsAdapter?.getSelected()?.let { it1 -> items.addAll(it1) }
            fragReceiveGifts?.giftsAdapter?.getSelected()?.let { it1 -> items.addAll(it1) }
    ...
    override fun getUserId(): String = purchaseGiftFor!!
