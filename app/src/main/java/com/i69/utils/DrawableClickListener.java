...
public abstract class DrawableClickListener implements OnTouchListener
{
     ...
     */
    public DrawableClickListener( final AppCompatEditText view, final int drawableIndex )
    {
     ...
     *            included to account for the size of a finger.
     */
    public DrawableClickListener( final AppCompatEditText view, final int drawableIndex, final int fuzz )
    {
        super();
        this.fuzz = fuzz;
    ...
    public static abstract class LeftDrawableClickListener extends DrawableClickListener
    {
         ...
         */
        public LeftDrawableClickListener( final AppCompatEditText view )
        {
         ...
         *            included to account for the size of a finger.
         */
        public LeftDrawableClickListener( final AppCompatEditText view, final int fuzz )
        {
    ...
    public static abstract class TopDrawableClickListener extends DrawableClickListener
    {
         ...
         */
        public TopDrawableClickListener( final AppCompatEditText view )
        {
         ...
         *            included to account for the size of a finger.
         */
        public TopDrawableClickListener( final AppCompatEditText view, final int fuzz )
        {
    ...
    public static abstract class RightDrawableClickListener extends DrawableClickListener
    {
         ...
         */
        public RightDrawableClickListener( final AppCompatEditText view )
        {
         ...
         *            included to account for the size of a finger.
         */
        public RightDrawableClickListener( final AppCompatEditText view, final int fuzz )
        {
    ...
    public static abstract class BottomDrawableClickListener extends DrawableClickListener
    {
         ...
         */
        public BottomDrawableClickListener( final AppCompatEditText view )
        {
         ...
         *            included to account for the size of a finger.
         */
        public BottomDrawableClickListener( final AppCompatEditText view, final int fuzz )
        {
