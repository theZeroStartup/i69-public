...
class VideoMultiStoryCommentListAdapter(
...
) : RecyclerView.Adapter<VideoMultiStoryCommentListAdapter.ViewHolder>() {
    private val formatter = SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault()).apply {
        timeZone = TimeZone.getTimeZone("UTC")
    }

    override fun onBindViewHolder(holder: VideoMultiStoryCommentListAdapter.ViewHolder, position: Int) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): VideoMultiStoryCommentListAdapter.ViewHolder =
        ViewHolder(
