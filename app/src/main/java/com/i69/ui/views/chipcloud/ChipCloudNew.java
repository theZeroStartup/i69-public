...
public class ChipCloudNew extends FlowLayout implements ChipListener {
    ...
    public ChipCloudNew(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public ChipCloudNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    ...
    public void addChip(IdWithValue chipItem, Boolean isTags) {
        ...
        LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.chip_looking_for, null, false);
        ...
        String secondPart = "";
        if (split.length>1) {
            secondPart = split[1].replaceAll("\"", "");
        }
        tx2.setText(" "+secondPart+" ");
